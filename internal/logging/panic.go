...
// The panic handler is based on the panic handler in OpenTofu.
// See: https://github.com/opentofu/opentofu/blob/main/internal/logging/panic.go

// This output is shown if a panic happens.
const panicOutput = `
!!!!!!!!!!!!!!!!!!!!!!!!!!! AGRICOLA CRASH !!!!!!!!!!!!!!!!!!!!!!!!!!!!

Agricola crashed! This is always indicative of a bug within Agricola.
Please report the crash with Agricola[1] so that we can fix this.

When reporting bugs, please include your Agricola version, the stack trace
shown below, and any additional information which may help replicate the issue.

[1]: https://github.com/anttikivi/agricola/issues
...
// PanicHandler is called to recover from an internal panic in Agricola, and
...
func PanicHandler() {
	...
	// to block progress, we can prevent some cases where Agricola may return
